...
public class PunishmentDAO {
    ...
    public void updateBan(Ban ban){
        conversify.getLogger().warn("Updating ban to database and cache list");
        datastore.save(ban);
    }
    ...
    public void updateWarning(Warning warning){
        conversify.getLogger().warn("Updating warning to database and cache list");
    ...
    public void updateMute(Mute mute){
        conversify.getLogger().warn("Updating mute to database and cache list");
        datastore.save(mute);
    }
}
